 ...
 * 添加图片 营业执照
 * 
 * add by wuxw 2018-10-20
 */
export default class AddBusinessLicencePage extends Component{
    ...
    _refreshStoreCredentialsInfo(){
        let storeCerdentials = storeMobx.getStoreCerdentialsOfStoreInfo(StoreConst.STORE_CREDENTIALS_CD_BUSINESS_LICENCE);
        //如果有多个则取第一个
        ...
        return(
            <View style={StoreStyles.container}>
                ...
                <ScrollView>
                    ...
                    {this._renderBusinessLicenceInfo()}
   ...
   _renderHeader() {
     ...
     * 营业执照 信息填写
     */
    _renderBusinessLicenceInfo(){
        return(
            <View style={StoreStyles.businessLicenceView}>
                <RowRightTextInputView
                    leftText="注册号"
                    textPlaceholder={"请输入注册号，必填"}
                    _onChangeText={(value) => { this.setState({value:value}); }}
